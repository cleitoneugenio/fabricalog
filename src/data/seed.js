...
const S2 = {
  ...
  dias: [
    ...
    { queima: 'F12', enfornas: ['F17 (R e JV)', '', ''],             qualidade: 'Pátio Molhado', estoque: 12, vendas: 7.5,  fornosDesocupados: 'F1 e metade do F2',         reforma: '',             qtdFunc: 7, ocorrencia: '***REMOVED***' },
...
const S3 = {
  ...
  dias: [
    ...
    { queima: 'F3',  enfornas: ['F8 (R e I)', '', ''],                qualidade: 'Pátio Molhado', estoque: 20, vendas: 3.8, fornosDesocupados: 'F9',         reforma: 'F6 em reforma', qtdFunc: 6, ocorrencia: '***REMOVED***' },
